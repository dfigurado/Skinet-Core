...
namespace Infrastructure.Services
{
    public class OrderService : IOrderService
    {
        ...
        {
            var baseket = await _basketRepo.GetBasketAsync(basketId);
            ...
            var spec = new OrderByPaymentIntentIdSpecification(baseket.PaymentIntentId);
            ...
            {
                // create order
                order = new Order(items, buyerEmail, shippingAddress, deliveryMethod, subtotal, baseket.PaymentIntentId);
